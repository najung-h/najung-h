...
<a href="https://doongzi.site" target="_blank">
  ...
  <img src="./assets/수상.jpg" width="200px" />
...
<!-- 아이타임(AI-Time) -->
### 👶 아이타임(AI-Time)
> **팀 프로젝트 · AI · 자폐 진단 디지털의료기기

<a href="https://i14a501.p.ssafy.io/" target="_blank">
  <img src="./assets/aitime-image.png" width="500px" />
</a>

AITime은 아동 행동 영상을 분석해 자폐 스펙트럼 장애(ASD) 진단에 활용되는 **행동 지표(눈맞춤, 호명반응, 모방행동 등)**를 자동 측정하는 AI 기반 자폐진단 솔루션입니다.
비전·음성 분석 파이프라인을 통해 행동 데이터를 정량화하여 의사 대시보드로 제공, 진단 과정의 관찰 데이터를 체계적으로 기록·분석할 수 있도록 설계했습니다.
특히 12~23개월 영유아 대상 행동 지표를 중심으로 영상 기반 정량 분석 지표를 구축해, 최대 1년까지 발생하는 ASD 진단 대기 문제를 완화하여 ASD 치료의 골든타임을 확보하고자 했습니다.
